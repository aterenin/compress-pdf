...
smaller. Libraries marked "own" are implemented in this crate on top of the
...
| Stripping | Remove non-visual parts: article threads, metadata, piece info, structure tree, thumbnails, spider info, alternate images, output intents. | document and page dictionaries | own, over lopdf |
...
| Stage | File | Reads | Writes | Responsibility |
|---|---|---|---|---|
