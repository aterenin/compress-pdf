...
smaller. The Done column is `x` implemented as described, `~` partly (details
under Implementation status), `.` not started. Libraries marked "own" are implemented in this crate on top of the
